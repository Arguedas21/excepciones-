...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            catch (FormatException ex) // Manejo de excepción de formato
            {
                Console.WriteLine("Error de formato: " + ex.Message);
            }
            catch (ArgumentNullException ex) // Manejo de excepción de argumento nulo
            {
                Console.WriteLine("Error: " + ex.Message);
            }
            catch (InvalidOperationException ex) // Manejo de excepción de operación inválida
            {
                Console.WriteLine("Operación no válida: " + ex.Message);
            }
            catch (Exception ex) // Manejo de excepción genérica
            {
...
// se insertaron algunas excepciones como InvalidOperationException, ArgumentNullException,FormatException, estos cambios mejoran la robustez del código al manejar posibles excepciones, evitando que el programa se cierre de manera inesperada
